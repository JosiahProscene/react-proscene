...
const AboutPS = () => {
    ...
    return (
        <div className="relative group w-full h-screen bg-[#fff] pt-8 flex items-center justify-center overflow-hidden">
            {/* Background Image */}
            <img
                src={un}
                alt="Government Offices Background"
            ...
            <div className="relative z-20 w-full h-full flex flex-col justify-center px-4 sm:px-8 md:px-16 lg:px-28">
                ...
                <div className={`transform transition-all duration-500 delay-75 ease-out
                    ...
                    <p className="text-white text-lg sm:text-xl md:text-2xl lg:text-xl
                        ...
                        We deliver secure, scalable technology solutions for government institutions, 
                        enabling efficient public service delivery, enhanced citizen engagement, 
                        and robust infrastructure for critical operations.
                    </p>
                </div>
                ...
                {/* Optional: Feature highlights for Public Sector */}
